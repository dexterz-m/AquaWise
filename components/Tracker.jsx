...
const Tracker = () => {
  ...
  return (
    <div className='bg-tuna-900 p-5 min-h-screen flex flex-col items-center'>
      ...
      <div className=''>
        <button className="btn btn-xs text-black-haze-100 bg-transparent border-none hover:bg-transparent" onClick={() => document.getElementById('my_modal_2').showModal()}>
        Edit daily goal <MdEdit className='text-anakiwa-500 text-lg' />
        </button>
          ...
          <div className="modal-box bg-shuttle-gray-800 flex flex-col items-center justify-center">
            ...
            <div className='flex flex-row items-center justify-center'>
              <input
                ...
                value={newTarget} // Bind to newTarget to capture user input
                onChange={(e) => setNewTarget(e.target.value)} // Update newTarget as the user types
              />
      ...
      <div className="card bg-shuttle-gray-800 min-w-sm w-4/6 max-w-md shadow-xl mt-20 mb-20 p-5 py-2">
        <div className="stat p-5">
          ...
          <div className='flex items-center justify-evenly'>
            <input type="number" placeholder="add" className="input w-24 my-5 mr-2 max-w-xs no-arrows" value={volume} onChange={(e) => setVolume(e.target.value)} />
          ...
          <button onClick={() => contributeVolume()} className="btn bg-anakiwa-600 hover:bg-anakiwa-700 text-black-haze-100 align-middle border-transparent focus:border-transparent focus:ring-0 hover:border-transparent hover:ring-0">Contribute</button>
        </div>
      </div>
